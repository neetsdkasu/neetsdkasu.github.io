...
class Lib {
    static parseInt(s: string): number | null {
        const n = parseInt(s);
    ...
    static withDefault<K,V>(m: Map<K, V>, k: K, d: V): V {
...
/* レベルアップコスト（ネット調べ） */
const LVUPCOST: [number, number, number][] = [
    [  200,  1,  0],    // Lv 1.0 -> Lv 1.5
    [  200,  2,  0],    // Lv 1.5 -> Lv 2.0
    [  200,  1,  0],    // Lv 2.0 -> Lv 2.5
    [  200,  1,  0],    // Lv 2.5 -> Lv 3.0
    [  400,  1,  0],    // Lv 3.0 -> Lv 3.5
    [  400,  1,  0],
    [  400,  1,  0],    // Lv 4.0 -> Lv 4.5
    [  400,  1,  0],
    [  600,  1,  0],    // Lv 5.0 -> Lv 5.5
    [  600,  1,  0],
    [  600,  1,  0],    // Lv 6.0 -> Lv 6.5
    [  600,  1,  0],
    [  800,  1,  0],    // Lv 7.0 -> Lv 7.5
    [  800,  1,  0],
    [  800,  1,  0],    // Lv 8.0 -> Lv 8.5
    [  800,  1,  0],
    [ 1000,  1,  0],    // Lv 9.0 -> Lv 9.5
    [ 1000,  1,  0],
    [ 1000,  1,  0],    // Lv 10.0 -> Lv 10.5
    [ 1000,  1,  0],
    [ 1300,  2,  0],    // Lv 11.0 -> Lv 11.5
    [ 1300,  2,  0],
    [ 1300,  2,  0],    // Lv 12.0 -> Lv 12.5
    [ 1300,  2,  0],
    [ 1600,  2,  0],    // Lv 13.0 -> Lv 13.5
    [ 1600,  2,  0],
    [ 1600,  2,  0],    // Lv 14.0 -> Lv 14.5
    [ 1600,  2,  0],
    [ 1900,  2,  0],    // Lv 15.0 -> Lv 15.5
    [ 1900,  2,  0],
    [ 1900,  2,  0],    // Lv 16.0 -> Lv 16.5
    [ 1900,  2,  0],
    [ 2200,  2,  0],    // Lv 17.0 -> Lv 17.5
    [ 2200,  2,  0],
    [ 2200,  2,  0],    // Lv 18.0 -> Lv 18.5
    [ 2200,  2,  0],
    [ 2500,  2,  0],    // Lv 19.0 -> Lv 19.5
    [ 2500,  2,  0],
    [ 2500,  2,  0],    // Lv 20.0 -> Lv 20.5
    [ 2500,  2,  0],
    [ 3000,  3,  0],    // Lv 21.0 -> Lv 21.5
    [ 3000,  3,  0],
    [ 3000,  3,  0],    // Lv 22.0 -> Lv 22.5
    [ 3000,  3,  0],
    [ 3500,  3,  0],    // Lv 23.0 -> Lv 23.5
    [ 3500,  3,  0],
    [ 3500,  3,  0],    // Lv 24.0 -> Lv 24.5
    [ 3500,  3,  0],
    [ 4000,  3,  0],    // Lv 25.0 -> Lv 25.5
    [ 4000,  3,  0],
    [ 4000,  4,  0],    // Lv 26.0 -> Lv 26.5
    [ 4000,  4,  0],
    [ 4500,  4,  0],    // Lv 27.0 -> Lv 27.5
    [ 4500,  4,  0],
    [ 4500,  4,  0],    // Lv 28.0 -> Lv 28.5
    [ 4500,  4,  0],
    [ 5000,  4,  0],    // Lv 29.0 -> Lv 29.5
    [ 5000,  4,  0],
    [ 5000,  4,  0],    // Lv 30.0 -> Lv 30.5
    [ 5000,  4,  0],
    [ 6000,  6,  0],    // Lv 31.0 -> Lv 31.5
    [ 6000,  6,  0],
    [ 6000,  6,  0],    // Lv 32.0 -> Lv 32.5
    [ 6000,  6,  0],
    [ 7000,  8,  0],    // Lv 33.0 -> Lv 33.5
    [ 7000,  8,  0],
    [ 7000,  8,  0],    // Lv 34.0 -> Lv 34.5
    [ 7000,  8,  0],
    [ 8000, 10,  0],    // Lv 35.0 -> Lv 35.5
    [ 8000, 10,  0],
    [ 8000, 10,  0],    // Lv 36.0 -> Lv 36.5
    [ 8000, 10,  0],
    [ 9000, 12,  0],    // Lv 37.0 -> Lv 37.5
    [ 9000, 12,  0],
    [ 9000, 12,  0],    // Lv 38.0 -> Lv 38.5
    [ 9000, 12,  0],
    [10000, 15,  0],    // Lv 39.0 -> Lv 39.5
    [10000, 15,  0],
    [10000,  0, 10],    // Lv 40.0 -> Lv 40.5
    [10000,  0, 10],
    [11000,  0, 10],    // Lv 41.0 -> Lv 41.5
    [11000,  0, 10],
    [11000,  0, 12],    // Lv 42.0 -> Lv 42.5
    [11000,  0, 12],
    [12000,  0, 12],    // Lv 43.0 -> Lv 43.5
    [12000,  0, 12],
    [12000,  0, 15],    // Lv 44.0 -> Lv 44.5
    [12000,  0, 15],
    [13000,  0, 15],    // Lv 45.0 -> Lv 45.5
    [13000,  0, 15],
    [13000,  0, 17],    // Lv 46.0 -> Lv 46.5
    [13000,  0, 17],
    [14000,  0, 17],    // Lv 47.0 -> Lv 47.5
    [14000,  0, 17],
    [14000,  0, 20],    // Lv 48.0 -> Lv 48.5
    [14000,  0, 20],
    [15000,  0, 20],    // Lv 49.0 -> Lv 49.5
 ...
 * 累積のほしのすなが700ほどズレる謎
 */
const LVUPCOSTSUM: [number, number, number][] = [
    [    200,   1,   0],    // Lv 1.0 -> Lv 1.5
    [    400,   2,   0],    // Lv 1.0 -> Lv 2.0
    [    600,   3,   0],    // Lv 1.0 -> Lv 2.5
    [    800,   4,   0],    // Lv 1.0 -> Lv 3.0
    [   1200,   5,   0],    // Lv 1.0 -> Lv 3.5
    [   1600,   6,   0],    // Lv 1.0 -> Lv 4.0
    [   2000,   7,   0],
    [   2400,   8,   0],    // Lv 1.0 -> Lv 5.0
    [   3000,   9,   0],
    [   3600,  10,   0],    // Lv 1.0 -> Lv 6.0
    [   4200,  11,   0],
    [   4800,  12,   0],    // Lv 1.0 -> Lv 7.0
    [   5400,  13,   0],
    [   6200,  14,   0],    // Lv 1.0 -> Lv 8.0
    [   7000,  15,   0],
    [   7800,  16,   0],    // Lv 1.0 -> Lv 9.0
    [   8600,  17,   0],
    [   9600,  18,   0],    // Lv 1.0 -> Lv 10.0
    [  10600,  19,   0],
    [  11600,  20,   0],
    [  12900,  22,   0],
    [  14200,  24,   0],
 ...
 */
const LIGHTLVUPCOSTSUM: [number, number, number][] = [
    [   3600,   3,   0],
    [   7200,   6,   0],
    [  10800,  10,   0],
    [  14400,  14,   0],
 ...
 */
const LIGHTLVUPCOSTSUM_X: [number, number, number][] = [
    [   3600,   3,   0],
    [   7200,   6,   0],
    [  10800,  10,   0],
    [  14400,  14,   0],
    ...
    [ 117000, 129,   0],
    [ 124200, 138,   0],
    [ 132300, 149,   0], /* 相違点 砂が+900 アメが+2 多い */
    [ 140400, 160,   0],
    [ 148500, 171,   0],
    [ 156600, 182,   0],
    [ 165600, 196,   0],
 ...
 */
const LVUPCOSTSUM_M: [number, number, number][] = [
    [  1900 - 21400,  60 - 600, 0], // Lv 15.0 -> Lv 15.5
    [  3800 - 21400, 120 - 600, 0], // Lv 15.0 -> Lv 16.0
    [  5700 - 21400, 180 - 600, 0], // Lv 15.0 -> Lv 16.5
    [  7600 - 21400, 240 - 600, 0], // Lv 15.0 -> Lv 17.0
    [  9800 - 21400, 300 - 600, 0],
    [ 12000 - 21400, 360 - 600, 0], // Lv 15.0 -> Lv 18.0
    [ 14200 - 21400, 420 - 600, 0],
    [ 16400 - 21400, 480 - 600, 0], // Lv 15.0 -> Lv 19.0
    [ 18900 - 21400, 540 - 600, 0],
    [ 21400 - 21400, 600 - 600, 0], // Lv 15.0 -> Lv 20.0
    [   2500,   60,    0],  // Lv 20.0 -> Lv 20.5
    [   5000,  120,    0],  // Lv 20.0 -> Lv 30.0
    [   8000,  210,    0],  // Lv 20.0 -> Lv 30.5
    [  11000,  300,    0],  // Lv 20.0 -> Lv 31.0
    [  14000,  390,    0],  // Lv 20.0 -> Lv 31.5
    [  17000,  480,    0],
    [  20500,  570,    0],
    [  24000,  660,    0],
    [  27500,  750,    0],
...
const TYPE_EFFECTIVENESS: Map<string, Map<string, number>> = new Map([
    [T00_NORMAL, new Map([
...
function typeEffectiveness(type1: string, type2: string, attackType: string): number {
...
const WEATHER_BOOST_LIST: [string, string[]][] = [
...
const WEATHER_BOOST_MAP: Map<string, string[]> = WEATHER_BOOST_LIST.reduce( (acc, e) => {
    acc.set(e[0], e[1]);
...
const monsters: Pokemon[] = [];

function calcAttack(mon: Pokemon): number {
...
function addList(mon: Pokemon): void {
    const ul = document.getElementById("pokemon_list") as HTMLUListElement;
...
function addPokemon(): void {
    ...
    const el = (name: string) => (form.elements.namedItem(name) as { value: string; }).value;
    const mon: Pokemon = {
        name: el("name"),
...
function inferLevel() {
    const form = document.getElementById("add_form") as HTMLFormElement;
    const elm = (name: string) => form.elements.namedItem(name) as HTMLInputElement;
    ...
    const search = (arr: [number, number, number][]) => {
        return Lib.bsearch(arr.length, (i: number) => {
            const diff1 = arr.at(-1)![1] - arr[i][1];
            const diff2 = arr.at(-1)![2] - arr[i][2];
            return diff2 >= candyXL && diff1 >= candy;
        });
    };
    const isMatch = (arr: [number, number, number][], index: number) => {
...
function calcRanking(): void {
    const form = document.getElementById("calc_form") as HTMLFormElement;
    const el = (name: string) => (form.elements.namedItem(name) as { value: string; }).value;
    const elm = (name: string) => form.elements.namedItem(name) as HTMLInputElement;
    ...
    const info = document.getElementById("target_info") as HTMLDivElement;
    const ranking = document.getElementById("ranking") as HTMLOListElement;
    ranking.innerHTML = "";
...
document.getElementById("add_button")!.addEventListener("click", () => {
    const dialog = document.getElementById("add_form_dialog") as HTMLDialogElement;
    ...
    const candy = form.elements.namedItem("candy") as HTMLInputElement;
    if (!(candy.oninput)) {
        candy.oninput = () => inferLevel();
    }
    const candyXL = form.elements.namedItem("candy_xl") as HTMLInputElement;
    if (!(candyXL.oninput)) {
        candyXL.oninput = () => inferLevel();
    }
    const light = form.elements.namedItem("light") as HTMLInputElement;
    if (!(light.oninput)) {
...
document.getElementById("calc_button")!.addEventListener("click", () => {
    const dialog = document.getElementById("calc_form_dialog") as HTMLDialogElement;
    const cancel = dialog.querySelector(".cancel") as HTMLButtonElement;
    if (!(cancel.onclick)) {
        cancel.onclick = () => dialog.close();
    }
...
function loadMonsterSample(): void {
